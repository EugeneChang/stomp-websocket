...
(function() {
  var Byte, Client, Frame, Stomp, zlib,
  ...
  Client = (function() {
    ...
    Client.prototype.gzipSend = function(destination, headers, body) {
      var buffers, lines, name, ref, value, zippedBuffer;
      if (headers == null) {
        headers = {};
      }
      if (!body) {
      ...
      return this.ws.send(new Uint8Array(Buffer.concat(buffers)).buffer);
    };
